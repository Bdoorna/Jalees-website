    ...
    <body>
         ...
         <div class='navbar navbar-expand-lg navbar-light text-light ' style='background-color: rgb(227, 217, 175);'>
          <div class='container-fluid'>
            ...
            <div class = 'req'>
            <?php
                    $query = "SELECT * FROM Offers INNER JOIN jobRequests ON jobRequests.ID = Offers.requestID WHERE parentID = ".$_SESSION['parentID']." AND createdAt > DATE_SUB( NOW( ) , INTERVAL 1 HOUR ) AND offerStatus = 'Pending' AND Offers.requestID=".$_GET['reqID'].";";
